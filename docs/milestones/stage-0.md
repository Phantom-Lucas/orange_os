...
- Branch：`baseline/2026-08`
- Tag：`baseline-2026-08`（带注释，指向最终元数据提交）
- Date：2026-08-15（Asia/Shanghai）
- 状态：DONE；基线范围、代码/测试冻结和证据归档均已完成
...
ARTIFACTS_DIR=build/baseline/2026-08/frozen-check-all-final2 \
  ./tests/run.sh --profile full --seed 20260815 --keep-failed          PASS (12/12)
...
冻结提交最终统一 runner 门禁：`build/baseline/2026-08/frozen-check-all-final2/20260815-101753-178844-20260815/`（12 个 case 全部 PASS）。
...
阶段 0 没有修改内核行为。代码/测试冻结点之后的元数据提交只更新证据文档；若需要回退测试基础设施，可使用保留的 legacy 脚本和旧 Make target。
